...
mysql_selectdb('teste')or die("selecionou?");
$todas = array();
$consultas = array();
while(1==1){
	...
	foreach( $consultas as $x=>$consulta){
		if($consultas[$x]['n'] > $minimo || $consultas[$x]['cont']<0)
		{
			...
			print_r("Depois de \033[0;34m" . number_format( $agora - $consultas[$x]['ultima_execucao'], 6) . "\033[0;0m s\tMais \033[0;32m$i\033[0;0m\tresultados para \033[0;31m{$consulta['pesquisa']}\033[0;0m$separador em \033[0;35m" . number_format( $agora - $start, 6) . "\033[0;0m s \033[0;33m$data\033[0;0m\n");
